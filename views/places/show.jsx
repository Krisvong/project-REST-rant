        ...
        {/* <div className="row"> */}
          ...
          <div className="col-md-6">
            ...
            <div className="card-body-buttons">
              ...
              <a href={`/places/${place.id}/edit`} className="btn btn-warning text-white mt-3"><i class="bi bi-pencil"></i> Edit</a>
              <form method="POST" action={`/places/${place.id}?_method=DELETE`}>
                <button type="submit" className="btn btn-danger mt-3"><i class="bi bi-trash"></i> Delete</button>
              </form>
              </div>
            </div>
          </div>
